...
<section class="footer">
    <section class="bg-red-950 text-dgcon-500">
        <div class="grid md:grid-cols-2 py-8 px-4 items-center mx-auto max-w-screen-xl lg:py-16 lg:px-6 space-y-10">
            ...
            <div class="mx-auto max-w-screen-md text-left">
                <h2 class="mb-4 md:text-3xl tracking-tight font-extrabold text-gray-900 text-xl dark:text-white">Sign up for our newsletter</h2>
                <form action="#">
    ...
    <footer class="bg-dgtext-800 text-dgcon-500">
        <div class="mx-auto w-full max-w-screen-xl">
            <div class="grid gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
                <div class="text-left">
                    <h2 class="mb-6 text-5xl font-semibold text-green-500 ">YourLogo</h2>
                    <p class="text-green-100">Lorem ipsum dolor sit amet consectetur adipisicing elit. Asperiores, consequuntur!</p>
                </div>
                <div class="text-left">
